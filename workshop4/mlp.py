...
class Subsample2x2(eqx.Module):
    ...
    def __call__(self, x: Float[Array, "c h w"]) -> Float[Array, "c h//2 w//2"]:
...
class SimpLeNet(eqx.Module):
    ...
    def __init__(self, key: PRNGKeyArray):
        ...
        self.S2 = Subsample2x2(num_channels=5)
        self.C3 = eqx.nn.Conv2d(5, 16, kernel_size = 5, padding =0, key = k2)
